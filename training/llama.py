...
class LLMClient:
    def __init__(self):
        self.api_key = ""
        self.model_name = "Llama-3-3-70B-Instruct-qnycp"
        self.client = AsyncOpenAI(api_key=self.api_key, base_url="https://Llama-3-3-70B-Instruct-qnycp.westus.models.ai.azure.com")
