...
class LLMClient:
    ...
    def extract_code(self, text: str) -> str:
        ...
        if not code_block_match:
            # Try to extract code from just triple backticks
    ...
    def process_item(self, item: Dict, gpu_id: int) -> Dict:
        ...
        while attempt < max_attempts:
            # System prompt + user prompt format for the local model
            prompt = f"""<|im_start|>system
You are a Python code rewriter. Slightly rewrite the provided code without changing its functionality. Only return the rewritten code, no explanations.
<|im_end|>
<|im_start|>user
Rewrite this Python code without changing its functionality:
